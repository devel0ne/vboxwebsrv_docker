...
ssh -o "StrictHostKeyChecking no" -p $SSH_PORT $1 "killall vboxwebsrv"
ssh -o "StrictHostKeyChecking no" -p $SSH_PORT -L 0.0.0.0:18083:$sshHost:$PORT $1 "killall vboxwebsrv; \"$VBOXWEBSRVPATH\" -p $PORT -A null -H $sshHost"
